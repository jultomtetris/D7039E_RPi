...
if("TRUE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/pi/catkin_ws/src/pluginlib)
...
if(NOT "/home/pi/catkin_ws/src/pluginlib/include;/usr/include " STREQUAL " ")
  set(pluginlib_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/src/pluginlib/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/pluginlib/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
